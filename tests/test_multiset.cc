...
TEST(method, lower_bound) {
    ...
    EXPECT_EQ(*a.lower_bound(6), 0);
    EXPECT_EQ(*a.lower_bound(0), *c.lower_bound(0));
}

TEST(method, lower_bound2) {
    s21::multiset<int> a;
    std::multiset<int> c;
    EXPECT_EQ(*a.lower_bound(1), *c.lower_bound(1));
}
...
TEST(method, upper_bound) {
    ...
    EXPECT_EQ(*a.upper_bound(5), 0);
    EXPECT_EQ(*a.upper_bound(0), *c.upper_bound(0));
    EXPECT_EQ(*a.upper_bound(-1), *c.upper_bound(-1));
}

TEST(method, upper_bound2) {
    s21::multiset<int> a;
    std::multiset<int> c;
    EXPECT_EQ(*a.upper_bound(1), *c.upper_bound(1));
}
